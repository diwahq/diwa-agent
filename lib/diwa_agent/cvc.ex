defmodule DiwaAgent.CVC do
  ...
  def verify_history(_context_id) do
    ...
    case :erlang.phash2(make_ref(), 4) do
       0 -> {:error, :broken_chain, %{inserted_at: DateTime.utc_now(), hash: "BAD", parent_hash: "GOOD"}}
       1 -> {:error, :invalid_hash, %{inserted_at: DateTime.utc_now(), hash: "BAD"}}
       2 -> {:error, :invalid_signature, %{inserted_at: DateTime.utc_now(), hash: "BAD"}}
       _ -> {:ok, :no_history}
    end
  end
end
