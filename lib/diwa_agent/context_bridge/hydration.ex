defmodule DiwaAgent.ContextBridge.Hydration do
  ...
  def hydrate(context_id, opts \\ []) do
    depth = opts[:depth] || :standard # :minimal, :standard, :comprehensive
    focus = opts[:focus] # list of keywords or tags
    _token_limit = opts[:token_limit] || 4000 # dummy limit for now
